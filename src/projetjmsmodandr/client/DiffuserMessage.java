 ...
 * @author kuka
 */
public class DiffuserMessage extends javax.swing.JFrame {

    /**
     * Creates new form DiffuserMessage
     */
    public DiffuserMessage() {
        initComponents();
    }
...
this.dispose();         // TODO ad        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiffuserMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiffuserMessage().setVisible(true);
            }
        });
    }
